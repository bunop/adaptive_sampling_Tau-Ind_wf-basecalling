...
#SBATCH --mem=16G
#SBATCH --error=methylong-5mC_5hmC-traditional.err
#SBATCH --output=methylong-5mC_5hmC-traditional.out
#SBATCH --job-name=methylong-5mC_5hmC-traditional
...
nextflow run nf-core/methylong -r 1.0.0 \
    ...
    -profile ibba,galileo -resume -params-file conf/params-methylong-5mC_5hmC.json \
    --outdir output_methylong-5mC_5hmC-traditional
