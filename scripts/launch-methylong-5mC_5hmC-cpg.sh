...
#SBATCH --mem=16G
#SBATCH --error=methylong-5mC_5hmC-cpg.err
#SBATCH --output=methylong-5mC_5hmC-cpg.out
#SBATCH --job-name=methylong-5mC_5hmC-cpg
...
nextflow run nf-core/methylong -r 1.0.0 \
    ...
    --outdir output_methylong-5mC_5hmC-cpg
